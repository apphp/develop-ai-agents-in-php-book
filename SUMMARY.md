...
* [2.1 Подключение LLM к PHP](chast-ii.-php-+-llm-integration/2.1-podklyuchenie-llm-k-php/README.md)
  ...
  * [2.1.5 OpenRouter и unified gateways](chast-ii.-php-+-llm-integration/2.1-podklyuchenie-llm-k-php/2.1.5-openrouter-i-unified-gateways.md)
  ...
  * [2.1.7 Получение JSON от LLM](chast-ii.-php-+-llm-integration/2.1-podklyuchenie-llm-k-php/2.1.7-poluchenie-json-ot-llm.md)
  ...
  * [2.1.14 Наблюдаемость AI-систем](chast-ii.-php-+-llm-integration/2.1-podklyuchenie-llm-k-php/2.1.14-nablyudaemost-ai-sistem.md)
  * [2.1.15 Кэширование и оптимизация стоимости](chast-ii.-php-+-llm-integration/2.1-podklyuchenie-llm-k-php/2.1.15-keshirovanie-i-optimizaciya-stoimosti.md)
  * [2.1.16 Итог главы](chast-ii.-php-+-llm-integration/2.1-podklyuchenie-llm-k-php/2.1.16-itog-glavy.md)
...
* [2.2 Structured AI-output](chast-ii.-php-+-llm-integration/2.2-structured-ai-output/README.md)
  ...
  * [2.2.6 Детерминированные пайплайны](chast-ii.-php-+-llm-integration/2.2-structured-ai-output/2.2.6-determinirovannye-paiplainy.md)
  * [2.2.7 Оценка уверенности результатов](chast-ii.-php-+-llm-integration/2.2-structured-ai-output/2.2.7-ocenka-uverennosti-rezultatov.md)
...
* [2.3 Архитектура промптов](chast-ii.-php-+-llm-integration/2.3-arkhitektura-promptov/README.md)
  ...
  * [2.3.3 Динамическая сборка промптов](chast-ii.-php-+-llm-integration/2.3-arkhitektura-promptov/2.3.3-dinamicheskaya-sborka-promptov.md)
  * [2.3.4 Версионирование промптов](chast-ii.-php-+-llm-integration/2.3-arkhitektura-promptov/2.3.4-versionirovanie-promptov.md)
...
* [3.1 Embeddings и semantic search](chast-iii.-embeddings-i-semantic-search/3.1-embeddings-i-semantic-search.md)
* [3.2 Vector databases](chast-iii.-embeddings-i-semantic-search/3.2-vector-databases.md)
* [3.3 Retrieval-Augmented Generation (RAG)](chast-iii.-embeddings-i-semantic-search/3.3-retrieval-augmented-generation-rag.md)
* [3.4 Advanced RAG systems](chast-iii.-embeddings-i-semantic-search/3.4-advanced-rag-systems.md)
...
* [5.1 Production architecture](chast-v.-production-ai-systems/5.1-production-architecture.md)
* [5.2 Observability и debugging](chast-v.-production-ai-systems/5.2-observability-i-debugging.md)
* [5.3 AI evaluation systems](chast-v.-production-ai-systems/5.3-ai-evaluation-systems.md)
* [5.4 Надёжность AI-систем](chast-v.-production-ai-systems/5.4-nadyozhnost-ai-sistem.md)
* [5.5 AI security](chast-v.-production-ai-systems/5.5-ai-security.md)
* [5.6 Оптимизация стоимости и производительности](chast-v.-production-ai-systems/5.6-optimizaciya-stoimosti-i-proizvoditelnosti.md)
* [5.7 Локальные модели и self-hosted AI](chast-v.-production-ai-systems/5.7-lokalnye-modeli-i-self-hosted-ai.md)
...
* [7.1 Эволюция AI engineering](chast-vii.-budushee-ai-engineering/7.1-evolyuciya-ai-engineering.md)
