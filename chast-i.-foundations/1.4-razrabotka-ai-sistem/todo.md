...
31. Agent vs workflow
32. Почему большинство AI-систем — это workflows
33. Tool calling architecture
34. Planning и execution
35. Reflection loops
36. Statefulness в AI systems
37. Durable execution
38. Human-in-the-loop systems
39. Когда агент НЕ нужен
40. Anti-patterns AI systems
...
Это один из самых важных инженерных вопросов во всей AI-разработке.

Многие системы называют агентами, хотя на самом деле они являются workflows.

Разница огромна.

### Workflow

Workflow – это заранее определённая последовательность шагов.
...
Такой pipeline может выглядеть “умным”, но он deterministic.

LLM внутри не делает архитектурных решений.
...
То есть execution path заранее неизвестен.

***

### Почему workflows побеждают

На практике большинство production AI-систем – это workflows.

Причины очень прагматичны.
...
– дороги\
– нестабильны\
– создают recursive loops\
– плохо observability-friendly

***

### Реальность индустрии

Многие “AI agents” на рынке:
...
Production engineering любит предсказуемость.
